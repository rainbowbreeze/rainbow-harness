...
Rainbow Harness is a collection of tools I use to manage my Hermes Agent fleet.
...
### `config-editor`
A configuration utility to safely apply patches and edit configuration files to Hermes Agent.
